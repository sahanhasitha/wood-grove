                 ...
                 <ul class="nav">
                     <li class="{{ Request::is('home') ? 'active' : '' }}">
                      ...
                      <li class="{{ Request::is('types') ? 'active' : '' }}">
                          ...
                          @else
                          <a class="nav-link {{ Request::is('types') ? 'active' : '' }}" href="/"
                              onclick="return false;">
                              <i class="fas fa-cubes"></i><span>Types</span> <small class="text-warning">(only admin can access this)</small>
                          </a>
                          @endif
                      ...
                      <li class="{{ Request::is('companies') ? 'active' : '' }}">
                          ...
                          @else
                          <a class="nav-link {{ Request::is('companies') ? 'active' : '' }}" href="/"
                              onclick="return false;">
                              Companies <small class="text-warning">(only admin can access this)</small>
                          </a>
                          @endif
