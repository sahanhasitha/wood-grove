...
class Images
{
    ...
    public function getImagenamefromImageTable($image_name)
    {

        return $this->imagename->where('name', 'like', $image_name . '.%')->first();
    }
     ...
     * @return Image object
     */
    // public function makeObject($new_image_name,$category)
    // {
    //     $image_service = new category_images();

    //     $image = $image_service::create(['name' => $new_image_name, 'category_id' => $category['id']]);
